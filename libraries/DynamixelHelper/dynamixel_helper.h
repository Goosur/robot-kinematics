...
public:
     ...
     */
    void groupLedEnable(vector<uint8_t> ids);

    /**
     * @brief Disable leds on a group of motors
     * @param ids - Vector of motor ids
     */
    void groupLedDisable(vector<uint8_t> ids);
     ...
     * @param ids - Vector of motor ids
     */
    void groupTorqueEnable(vector<uint8_t> ids);

    /**
     * @brief Disable torque on a group of motors
     * @param ids - Vector of motor ids
     */
    void groupTorqueDisable(vector<uint8_t> ids);
     ...
     */
    void groupSetAngle(vector<uint8_t> ids, vector<double> vals);

    /**
     * @brief Retrieve the current angles of a group of motors
     * @param ids - Vector of motor ids
     * @return vector<double> - Current angles of the motors of interest in radians
     */
    vector<double> groupGetAngle(vector<uint8_t> ids);
