...
Eigen::Matrix<double, 4, 4> FK::generate_transform(double alpha, double a,
...
vector<double> FK::get_gripper_coords(int n_frames, vector<double> alphas,
                                      vector<double> as, vector<double> ds,
                                      vector<double> thetas) {
  Eigen::Matrix<double, 4, 4> T_0N =
      generate_transform(alphas[0], as[0], ds[0], thetas[0]);
